...
The script in [`examples/03-agent-workflow-components`](https://github.com/SmythOS/sre/blob/main/examples/03-agent-workflow-components/01-workflow.ts) demonstrates this programmatic approach.
