...
/******************************************************
 * !! AI ASSISTANTS — DO NOT EDIT THIS FILE !!
 *
 * Model definitions are now stored and managed in the
 * MODELS_PATH with some JSON files. This file is NO LONGER the source of truth
 * at runtime — edits here have NO EFFECT on behavior.
 *
 * To add or update model capabilities (e.g. features,
 * tokens, pricing), use the JSON files in the MODELS_PATH instead.
 ******************************************************/
